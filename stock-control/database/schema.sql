...
-- ─── Personas: padrón compartido con otros módulos (ej. turnos-prioritarios) ───
--
-- Esta base ya tiene una tabla `personas` (~96.000 registros) que se usa como
-- padrón compartido de pacientes/beneficiarios. No se recrea acá; columnas
-- reales: id, tipo_documento, documento, apellido, nombre, sexo, calle,
-- numeracion, departamento, piso, barrio, cuit_cuil, active, created_at,
-- updated_at.
