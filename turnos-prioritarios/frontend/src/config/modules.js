...
// 'dashboard' y 'usuarios' no se incluyen acá: el Dashboard siempre es
// visible, y Usuarios ya está controlado por el rol admin.
export const MODULES = [
  { key: 'turnos',        icon: '📅', label: 'Turnos' },
  { key: 'personas',      icon: '🧑', label: 'Personas' },
  { key: 'profesionales', icon: '🩺', label: 'Profesionales' },
  { key: 'instituciones', icon: '🏥', label: 'Instituciones' },
