...
export default function Users() {
  ...
  const load = () =>
    axios.get('/sigo/api/users.php').then(r => { setUsers(r.data); setLoading(false); });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editing) {
        await axios.put(`/sigo/api/users.php?id=${editing}`, payload);
      } else {
        await axios.post('/sigo/api/users.php', payload);
      }
      setShowForm(false);
      load();
    } catch (err) {
